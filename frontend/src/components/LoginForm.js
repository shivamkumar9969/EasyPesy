...
const LoginForm = ({ onLogin }) => {
  ...
  const handleForgotPassword = () => {
    setShowForgotPassword(true); // Show email input field and reset password button
  };
  ...
  return (
    <>
      <div className="flex justify-center items-center md:items-start  h-screen  bg-[#fcfcfc] ">
        <div className="w-full h-2/3 md:h-1/2 max-w-md bg-opacity-70 bg-white md:mt-28 rounded-2xl shadow-2xl p-8">
